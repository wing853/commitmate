...
INSERT INTO todo_tb (work, is_done, group_id, user_id, fine_id) VALUES
-- 알고리즘방 (group_id=1)
('백준 1234번 문제 풀이', true, 1, 1, NULL),     -- 민수(1) 완료
('백준 5678번 문제 풀이', false, 1, 2, NULL),    -- 길동(2) 미완료
('주간 코드리뷰 자료 준비', false, 1, 1, NULL),  -- 민수(1) 미완료

-- 새벽기상방 (group_id=2)
('6:30 기상 인증샷', false, 2, 1, 1);           -- 민수(1) 실패 -> 벌금(1) 연결